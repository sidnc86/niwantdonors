...
describe RemarksController do
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created remark" do
        post :create, {:remark => valid_attributes}, valid_session
        response.should redirect_to(Remark.last)
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested remark" do
        ...
        Remark.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => remark.to_param, :remark => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested remark as @remark" do
        remark = Remark.create! valid_attributes
        put :update, {:id => remark.to_param, :remark => valid_attributes}, valid_session
        assigns(:remark).should eq(remark)
      end

      it "redirects to the remark" do
        remark = Remark.create! valid_attributes
        put :update, {:id => remark.to_param, :remark => valid_attributes}, valid_session
        response.should redirect_to(remark)
      end
    end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the remarks list" do
      remark = Remark.create! valid_attributes
      delete :destroy, {:id => remark.to_param}, valid_session
      response.should redirect_to(remarks_url)
    end
  end
